          ...
          <>
            ...
            {showReset && (
              <form onSubmit={handleResetPassword} style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 10 }}>
                <input type="email" value={resetEmail} onChange={e => setResetEmail(e.target.value)} placeholder="Enter your email" required style={{ padding: '0.8em 1em', borderRadius: 10, border: '1.5px solid #b6b6d8', fontSize: '1em' }} />
                <button type="submit" style={{ background: '#1976d2', color: '#fff', border: 'none', borderRadius: 10, fontWeight: 700, fontSize: '1em', padding: '0.7em 0', cursor: 'pointer' }}>Send Reset Email</button>
