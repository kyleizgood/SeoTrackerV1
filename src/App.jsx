...
import { syncTicketWithPackage, isBusinessProfileClaimingTicket } from './ticketSyncUtils';
      ...
      snapshot.docChanges().forEach(change => {
        ...
        if (change.type === 'modified') {
          ...
          if (isBusinessProfileClaimingTicket(ticket) && ticket.companyId) {
            ...
            syncTicketWithPackage(ticket, ticket.status, packages, setPackages, setCachedData, user, setIsUpdatingPackages, savePackages, toast);
    ...
    <>
      ...
      {user ? (
        ...
        {/* Keep old routes for backward compatibility */}
                    ...
                    <Route path="/tickets" element={user ? <Tickets darkMode={darkMode} setDarkMode={setDarkMode} packages={packages} setPackages={setPackages} setCachedData={setCachedData} user={user} setIsUpdatingPackages={setIsUpdatingPackages} savePackages={savePackages} toast={toast} /> : <Navigate to="/login" replace />} />
